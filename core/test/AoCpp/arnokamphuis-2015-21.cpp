...
class items {
   public:
    ...
    int cost() {
        ...
        if (ring1 != rings.end()) {
            c += ring1->second.first;
        }
        if (ring2 != rings.end()) {
            c += ring2->second.first;
        }
        return c;
    }
    ...
    void print(bool current) {
        ...
        if (current) {
            ...
            if (arm != armor.end())
                std::cout << "Armor: " << arm->first << std::endl;
            if (ring1 != rings.end())
                std::cout << "Ring 1: " << ring1->first << std::endl;
            if (ring2 != rings.end())
                std::cout << "Ring 2: " << ring2->first << std::endl;
        } else {
            std::cout << "Weapon: " << it.weapon->first << std::endl;
            if (it.arm != armor.end())
                std::cout << "Armor: " << it.arm->first << std::endl;
            if (it.ring1 != rings.end())
                std::cout << "Ring 1: " << it.ring1->first << std::endl;
            if (it.ring2 != rings.end())
                std::cout << "Ring 2: " << it.ring2->first << std::endl;
        }
        std::cout << "=========================" << std::endl;
    }
