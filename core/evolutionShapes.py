...
def constructNN():
    ...
    dense_layer1 = keras.layers.Dense(len(feature_cols), activation="relu")
    dense_layer2 = keras.layers.Dense(len(feature_cols), activation="relu")
    dense_layer3 = keras.layers.Dense(len(feature_cols), activation="relu")

    output_layer = keras.layers.Dense(len(comp.get_passes()), activation="sigmoid")
